...
def main():
    ...
    filename_encoder = f"./models/kmanakkal_cifar10_feature_encoder_{CLASS_NUM}way_{SAMPLE_NUM_PER_CLASS}shot.pkl"
    filename_network = f"./models/kmanakkal_cifar10_relation_network_{CLASS_NUM}way_{SAMPLE_NUM_PER_CLASS}shot.pkl"
