...
class RelationNetwork(nn.Module):
    ...
    def forward(self,x):
        ...
        out = torch.sigmoid(self.fc2(out))  # torch.nn.functional.sigmoud is deprecated
        return out
    ...
    for episode in range(EPISODE):
        ...
        if episode%5000 == 0:
            ...
            if test_accuracy > last_accuracy:
                ...
                # save networks
                torch.save(feature_encoder.state_dict(),str("./models/l2norm_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                torch.save(relation_network.state_dict(),str("./models/l2norm_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
